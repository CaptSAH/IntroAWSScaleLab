...
8. Select the remaining bucket and click ![Delete button]() to delete the remaining bucket
...
3. In the **AWS Management Console**, on the ![Services button]() menu, select **CloudFormation**
